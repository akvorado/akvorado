<template>
  <div class="w-full md:flex md:flex-row">
    <div class="flex-none overflow-y-auto bg-gray-50 dark:bg-gray-900 dark:text-gray-200 md:mx-0 py-4 px-4 sm:px-6 md:pl-0 md:pr-8">
      <nav class="text-sm mx-auto md:mx-0">
        <ul class="space-y-1 md:space-y-8 pl-6">
          <li v-for="document in toc" :key="document.name" class="md:space-y-2">
            ...
            <ul class="space-y-1 md:space-y-2 md:block"
    ...
    <div class="md:relative flex grow md:overflow-y-auto md:shadow-md" ref="contentEl">
      <div class="py-4 px-4 md:px-16 max-w-full">
        <div class="prose prose-sm md:prose-base mx-auto dark:prose-invert prose-h1:border-b-2 dark:prose-h1:border-gray-700 prose-img:center prose-pre:rounded"
             v-html="markdown">
        </div>
      </div>
    </div>
