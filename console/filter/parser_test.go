...
func TestValidFilter(t *testing.T) {
	cases := []struct {
		...
		{Input: `MplsLabel1=20001`, Output: `MplsLabel1 = 20001`},
		{Input: `MplsLabel2=20001`, Output: `MplsLabel2 = 20001`},
		{Input: `MplsLabel3=20001`, Output: `MplsLabel3 = 20001`},
		{Input: `MplsLabel4=20001`, Output: `MplsLabel4 = 20001`},
...
func TestInvalidFilter(t *testing.T) {
	cases := []struct {
		...
		{Input: `MplsLabel1=20001a`},
		{Input: `MplsLabel2=20001a`},
		{Input: `MplsLabel3=20001a`},
		{Input: `MplsLabel4=20001a`},
		{Input: `EType = ipv7`},
		{Input: `Proto = 100 AND`},
		{Input: `AND Proto = 100`},
