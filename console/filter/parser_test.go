...
func TestValidFilter(t *testing.T) {
	cases := []struct {
		...
		{Input: `ExporterName="something'"`, Output: `ExporterName = 'something\''`},
		{Input: `ExporterName="something\\"`, Output: `ExporterName = 'something\\'`},
		{Input: `ExporterName="something with \"escaped quotes\""`, Output: `ExporterName = 'something with "escaped quotes"'`},
		{Input: `ExporterName='something with \'escaped quotes\''`, Output: `ExporterName = 'something with \'escaped quotes\''`},
		{Input: `ExporterName="backslash \\ test"`, Output: `ExporterName = 'backslash \\ test'`},
		{Input: `ExporterName='backslash \\ test'`, Output: `ExporterName = 'backslash \\ test'`},
		{Input: `ExporterName="mixed \\ and \" escapes"`, Output: `ExporterName = 'mixed \\ and " escapes'`},
		{Input: `ExporterName='mixed \\ and \' escapes'`, Output: `ExporterName = 'mixed \\ and \' escapes'`},
		{Input: `ExporterName!="something"`, Output: `ExporterName != 'something'`},
		...
		{Input: `FlowDirection = ingress`, Output: `FlowDirection = 'ingress'`},
		{Input: `FlowDirection = EGRESS`, Output: `FlowDirection = 'egress'`},
		{Input: `flowdirection != undefined`, Output: `FlowDirection != 'undefined'`},
