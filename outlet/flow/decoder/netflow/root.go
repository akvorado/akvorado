...
func (nd *Decoder) Decode(in decoder.RawFlow, options decoder.Options, bf *schema.FlowMessage, finalize decoder.FinalizeFlowFunc, _ *bart.Fast[pb.RawFlow_DecapsulationProtocol]) (int, error) {
	if len(in.Payload) < 2 {
